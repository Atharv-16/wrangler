...
public enum TokenType implements Serializable {
   ...
   * This type is associated with values that represent data sizes with units (e.g., "10KB", "1.5MB").
   */
  BYTE_SIZE,

  /**
   * Represents the enumerated type for the object of type {@code TimeDuration}.
   * This type is associated with values that represent time durations with units (e.g., "100ms", "2.5s").
   */
  TIME_DURATION
}
